        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(valid){
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_CREATE, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try{
                                ...
                                Toast.makeText(StartVisit.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(StartVisit.this, "Failed to Get Data",Toast.LENGTH_SHORT).show();
                        }
                    }){
                    ...
                    RequestHandler.getInstance(StartVisit.this).addToRequestQueue(stringRequest);
